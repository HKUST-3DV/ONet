...
class Generator3D(object):
    ...
    def generate_mesh(self, data, return_stats=True, return_latentcode=True):
        ...
        if return_stats and return_latentcode:
            return mesh, stats_dict, c
        elif return_latentcode:
            return mesh, {}, c
        elif return_stats:
